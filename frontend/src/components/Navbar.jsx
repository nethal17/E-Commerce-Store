			...
			<div className='container px-4 py-3 mx-auto'>
				<div className='flex flex-wrap items-center justify-between'>
					...
					<nav className='flex flex-wrap items-center gap-6'>
						<Link
							to={"/"}
							className='text-gray-300 transition duration-300 ease-in-out hover:text-sky-400'
						>
							Home
						</Link>
						{user && (
						...
						{isAdmin && (
							<Link
								className='flex items-center px-3 py-1 font-medium text-white transition duration-300 ease-in-out rounded-md bg-sky-700 hover:bg-sky-600'
								to={"/secret-dashboard"}
							>
						...
						{user ? (
							...
							<>
								...
								<Link
									to={"/login"}
									className='flex items-center px-4 py-2 text-white transition duration-300 ease-in-out bg-gray-700 rounded-md hover:bg-gray-500'
								>
