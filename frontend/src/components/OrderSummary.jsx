...
("pk_test_51RdZwpBQulx4sQOGzIjuw12uBFTMu2UjZ3RxWZD16E243CdQituxMKZb4r9jgbahen8CIhGy8JmM8GS5m05LgTFC000xIT1ppi");
        ...
        >
            ...
            <div className="space-y-4">
                <div className="space-y-2">
                    <d1 className="flex items-center justify-between gap-4">
                        <dt className="text-base font-normal text-gray-300">Original Price</dt>
                        <dd className="text-base font-medium text-sky-400">${formattedSubtotal}</dd>
                    </d1>
                    ...
                    <d1 className="flex items-center justify-between gap-4 pt-2 border-t border-gray-600">
                ...
                <div className='flex items-center justify-center gap-2'>
					...
					<Link
						to='/'
						className='inline-flex items-center gap-2 text-sm font-medium underline text-sky-400 hover:text-sky-300 hover:no-underline'
					>
						Continue Shopping
						<MoveRight size={16} />
					</Link>
